...
type CtxData struct {
 ...
 // ctx -> Ctx
func GetCtxData(ctx context.Context) (cd CtxData){
	cd.ClientIP =ctx.Value("ClientIP")
	cd.RequestID =ctx.Value("RequestID")
	cd.DentifyID =ctx.Value("DentifyID")
	cd.ServerID =ctx.Value("ServersID")
	return 
}
...
func (c *MLogger)Debugw(msg string,ctx context.Context,args ...interface{}) {
	m :=[]interface{}{}
	cname:="Context"
	m =append(m,cname)
	m = append(m,ctx)
...
func (c *MLogger)Infow(msg string,ctx context.Context,args ...interface{}){
	m :=[]interface{}{}
	cname:="Context"
	m =append(m,cname)
	m = append(m,ctx)
...
func (c *MLogger)Warnw(msg string,ctx context.Context,args ...interface{}){
	m :=[]interface{}{}
	cname:="Context"
	m =append(m,cname)
	m = append(m,ctx)
...
func (c *MLogger)Errorw(msg string,ctx context.Context,args ...interface{}){
	m :=[]interface{}{}
	cname:="Context"
	m =append(m,cname)
	m = append(m,ctx)
...
func (c *MLogger)DPanicw(msg string,ctx context.Context,args ...interface{}){
	m :=[]interface{}{}
	cname:="Context"
	m =append(m,cname)
	m = append(m,ctx)
...
func (c *MLogger)Panicw(msg string,ctx context.Context,args ...interface{}){
	m :=[]interface{}{}
	cname:="Context"
	m =append(m,cname)
	m = append(m,ctx)
...
func (c *MLogger)Fatalw(msg string,ctx context.Context,args ...interface{}){
	m :=[]interface{}{}
	cname:="Context"
	m =append(m,cname)
	m = append(m,ctx)
